...
--
-- Host: localhost
-- Generation Time: Dec 10, 2018 at 06:34 AM
...
(1, 1, 14, 'cuong', '123', 'gggggg', 'alfons.png', 'blazel.png', 'alakin.png', 'captain_kathleen.png', 'fggg', 0, 1.00, 4.00, '4');
...
INSERT INTO `Reviews` (`IdApplication`, `IdUser`, `ReviewDate`, `ContentReview`) VALUES
(1, 2, '2018-11-05', 'Ứng dụng này cũng tạm được'),
(2, 2, '2018-11-05', 'Ứng dụng gì mà chán quá vậy'),
(1, 3, '2018-11-05', 'Cũng hay đấy');
...
--
ALTER TABLE `Application`
  MODIFY `IdApplication` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
